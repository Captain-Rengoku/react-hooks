  ...
  return (
    <ThemeContext.Provider value={{ theme, setTheme }}>
      <UserContext.Provider value={{ user, setUser }}>
        <div className="bg-gray-900 border-2 border-blue-500 rounded-lg p-2 m-2 mt-6">
          <p className="text-amber-400">
            UseContextParent provides the Data{" "}
...
export const UseContextExmParentTwo = () => {
  ...
  return (
    <MyContext.Provider value={sharedData}>
      <div className="bg-gray-900 border-2 border-blue-500 rounded-lg mt-4 p-2 m-2">
        <p className="text-amber-400">
          UseContextParentTwo provides the Data{" "}
